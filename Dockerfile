...
RUN apt-get -y install sudo wget curl nano vim ca-certificates
RUN apt-get -y install --install-recommends wine wine32 wine64
RUN mkdir /usr/share/wine/mono /usr/share/wine/gecko && \
